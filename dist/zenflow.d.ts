 ...
 */
declare const addChiselGroup: (id: string) => string;
/**
 * Remove chisel group
 *
 * @see https://minetweaker3.aizistral.com/wiki/ModTweaker:Chisel_2_Support
 */
declare const removeChiselGroup: (id: string) => string;
/**
 * Add block variant to chisel group
 *
 * @see https://minetweaker3.aizistral.com/wiki/ModTweaker:Chisel_2_Support
 */
declare const addChisel: (group: string) => (id: string) => string;
/**
 * Remove block from chisel group
 *
 * @see https://minetweaker3.aizistral.com/wiki/ModTweaker:Chisel_2_Support
 */
declare const removeChisel: (id: string) => string;
